...
A documentação da API está disponível por meio da [Coleção do Postman](./BMA_Acesso_Integracao_Externa.json) incluída neste repositório. Ela contém as requisições, parâmetros, exemplos de uso e facilita a validação dos endpoints durante a integração.
...
* **Manual Técnico:** Leia o [Manual da Integração](./MANUAL_INTEGRACAO_BMA_V3.pdf) atentamente para compreender o fluxo detalhado das rotas, parâmetros aceitos, respostas de erro e especificações de payloads.
